...
- Bonus points for open source contributions.`;
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full flex-1">
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-white tracking-tight">Create Interview Prep Kit</h1>
        ...
        <div className="flex items-center space-x-2 mt-4">
          ...
          >
            Load PostHog Staff Engineer (Full Spec)
          </button>
          <button
            type="button"
            onClick={handleFillStub}
            className="text-xs px-2.5 py-1 rounded-lg bg-slate-800 text-slate-300 border border-slate-700 hover:bg-slate-700 transition-colors"
          >
            Load 2-Line Stub Test Case
          </button>
        </div>
      </div>

      {error && (
        <div className="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-sm flex items-start space-x-2.5">
      ...
      {isGenerating ? (
        ...
        <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 shadow-2xl">
          <div className="text-center max-w-md mx-auto mb-8">
            ...
            <h2 className="text-xl font-bold text-white">Synthesizing Your Prep Kit</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 space-y-5">
            <div>
              ...
              <textarea
                ...
                className="w-full p-4 rounded-xl bg-slate-950 border border-slate-800 text-slate-200 placeholder-slate-500 text-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 font-sans leading-relaxed"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-slate-200 placeholder-slate-500 text-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                />
              ...
              <div>
                <label className="flex items-center space-x-2 text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">
                  ...
                  <span>Days Available Before Interview ({days} Days)</span>
                </label>
                <input
                  type="range"
                  min={1}
          ...
          <div className="flex items-center justify-end space-x-4">
            <button
              type="submit"
              className="flex items-center space-x-2 px-8 py-3.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm shadow-lg shadow-indigo-600/30 transition-all hover:scale-[1.02]"
            >
